...
const namePrefixed = ['imagevenue', 'imagezilla', 'pixhost', 'stooorage', 'imgchili', 'sharenxs'];
const nameSuffixed = ['dumppix'];
const nameInHosting = ['pixhost', 'stooorage', 'turboimagehost', 'imgdragon', 'imgspice', 'pixroute', 'imagevenue'];
const nameInThumb = ['pimpandhost', 'pixhost', 'postimage', 'stooorage', 'turboimagehost', 'picstate', 'sharenxs', 'picpie'];
const noHTTPS = ['imagevenue', 'depic', 'pimpandhost', 'picsee', 'imagezilla', 'imagebam'];
 ...
 * @returns {Promise}
 */
const resolveFromHosting = (hostingUrl) =>
...
const resolve = (hostingURL, thumbURL, forceOriginalName) => {
  ...
  const loadFromHosting = () =>
    resolveFromHosting(hostingURL).then((img) =>
      download({
        url: img.src,
        headers: { Referer: hostingURL }
      }).then((file) => ({
