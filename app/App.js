      ...
      <div className="app">
        <div className="app_main">
          <div className="app_main_controls">
            <NewTaskForm toggleImportDialogue={this.toggleImportDialogue} />
          </div>
        ...
        <div className="app_side">
          <div className={cn('app_side_settings', { expanded: this.state.fullSettings })}>
            <Settings isToggled={this.state.fullSettings} toggle={this.toggleSettings} data={store._} update={store.setData} />
          </div>
        ...
        <Modal toggleVisibility={this.toggleImportDialogue} visible={this.state.importDialogue}>
