  ...
  render() {
    return (
      <div className="actions">
        <button className={cn('actions_btn', { clip: true, clip_on: store._.clipboard })} onClick={this.onClipboardClick}>
          <i className="fa fa-copy" />
          {store._.clipboard ? <span> Stop Clipboard Monitoring</span> : <span> Start Clipboard Monitoring</span>}
        </button>
