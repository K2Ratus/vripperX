      ...
      <div className={cn('settings', { toggled: isToggled })}>
        ...
        {isToggled &&
          <div className='settings_main'>
            ...
            {this.makeCheckbox('forumFolder', 'Subforum name folders')}
            ...
            {this.makeCheckbox('sitePrefixSep', 'Site Prefix folder')}
            {!!data.sitePrefixSep &&
              this.makeCheckbox('sitePrefixCut', 'cut Site Prefix from Thread name')}
