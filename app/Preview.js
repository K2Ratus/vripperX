  ...
  renderLoading(target) {
    return (
      <div className="preview_loading">
        ...
        <div className="preview_loading_url" onClick={() => this.openLink(target.url)}>
          {target.url}
        </div>
      </div>
    );
      ...
      <div className="preview_album">
        <div className="preview_album_info">
          ...
          >
            ...
            <div className="preview_album_info_id_val">{this.getTitle(target)}</div>
          </div>
          {target.pDone > 0 && (
            <div
            ...
            >
              ...
              <div className="album_info_folder_name">{_.last(target.dest.split(isWin32 ? '\\' : '/'))}</div>
            </div>
          )}
        </div>
